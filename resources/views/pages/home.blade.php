        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    ...
                    <div
                        class="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-100 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900">
                        <!-- Hero Section -->
                        <section class="relative py-20 lg:py-32 overflow-hidden">
                            <!-- Background decorations -->
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20">
                            </div>
                            <div class="absolute -top-40 -right-40 w-80 h-80 bg-primary-400/20 rounded-full blur-3xl">
                            </div>
                            ...
                            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div class="text-center space-y-8">
                                    <div class="space-y-4">
                                        ...
                                        <p
                                            class="max-w-2xl mx-auto text-lg md:text-xl text-zinc-600 dark:text-zinc-400 text-balance">
                                            Discover amazing products with our modern e-commerce platform. Built with
                                            Laravel, Livewire, and cutting-edge design.
                                        </p>
                                    </div>
                        ...
                        <section class="py-16 lg:py-24">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    <!-- Feature 1 -->
                                    <div class="card card-hover motion-preset-fade-sm">
                                        <div class="card-body text-center space-y-4">
                                            <div
                                                class="w-16 h-16 mx-auto bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center shadow-lg">
                                            ...
                                            <h3 class="text-xl font-semibold text-zinc-900 dark:text-white">Lightning
                                                Fast</h3>
                                            <p class="text-zinc-600 dark:text-zinc-400">Optimized for speed and
                                                performance with modern web technologies</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card card-hover motion-preset-fade-sm">
                                        <div class="card-body text-center space-y-4">
                                            <div
                                                class="w-16 h-16 mx-auto bg-gradient-to-br from-success-500 to-success-600 rounded-2xl flex items-center justify-center shadow-lg">
                                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                            ...
                                            <h3 class="text-xl font-semibold text-zinc-900 dark:text-white">Secure &
                                                Trusted</h3>
                                            <p class="text-zinc-600 dark:text-zinc-400">Your data and transactions are
                                    ...
                                    <div class="card card-hover motion-preset-fade-sm">
                                        <div class="card-body text-center space-y-4">
                                            <div
                                                class="w-16 h-16 mx-auto bg-gradient-to-br from-warning-500 to-warning-600 rounded-2xl flex items-center justify-center shadow-lg">
                                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                            ...
                                            <h3 class="text-xl font-semibold text-zinc-900 dark:text-white">Customer
                                                First</h3>
                                            <p class="text-zinc-600 dark:text-zinc-400">24/7 support and hassle-free
                                                returns for the best shopping experience</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- CTA Section -->
                        <section
                            class="py-16 lg:py-24 bg-gradient-to-r from-primary-600 to-primary-700 dark:from-primary-800 dark:to-primary-900">
                            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
                                ...
                                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                    <a href="#"
                                        class="btn bg-white text-primary-600 border-white hover:bg-primary-50 btn-lg">
                                        Browse Products
                                    </a>
                                    <a href="#"
                                        class="btn bg-transparent text-white border-white hover:bg-white/10 btn-lg">
                                        Learn More
                                    </a>
                                </div>
                            </div>
